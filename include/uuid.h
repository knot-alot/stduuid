    ...
    uuid operator()() {
        ...
        std::array<uint8_t, 16> bytes = {
            {static_cast<unsigned char>((newId.Data1 >> 24) & 0xFF),
             ...
             newId.Data4[0], newId.Data4[1], newId.Data4[2], newId.Data4[3], newId.Data4[4], newId.Data4[5],
        ...
        std::array<uint8_t, 16> arrbytes = {{bytes.byte0, bytes.byte1, bytes.byte2, bytes.byte3, bytes.byte4,
